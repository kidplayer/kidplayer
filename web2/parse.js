...
var link =
  "https://www.bilibili.com/video/BV1oA411s77k?p=12&spm_id_from=pageDriver";

"undefined" != typeof ga && ga("send", "event", "analysis", "analysis-normal");
var e = Math.random()
    .toString(10)
    .substring(2),
  n = generateStr(link + "@" + e).toString(10);
var o = "X-Client-Data";
var a = "https://service0.iiilab.com";
site = "bilibili";
$.ajax({
  type: "POST",
